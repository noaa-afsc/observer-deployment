...
# Create figure
f1 <- ggplot(mod_df[STRATA != "EM TRW EFP"], aes(x = rate, y = pct_diff)) +
...
Figure 1. Difference in means (%, monitored - unmonitored) against monitoring rate for years 2013 through 2021. Each point represents one year of data. Lines represent the linear regression of the points. Statistical significance is defined for points as year, stratum, and metric combinations for which the *p*-value from the permutation test was $\le$ 0.05/6 and for lines as stratum and metric combinations for which the *p*-value for the linear model slope coefficient was $\le$ 0.05/6.
