...
# Load Packages ----
library(ggplot2)
library(JACtools)    # devtools::install_github("JenC36/JACtools")
## 
...
##      and this is my attempt to reduce my own, continual confusion. These comments can be ignored 
...
##              m=number successes in population (m+n=N=population size, 
