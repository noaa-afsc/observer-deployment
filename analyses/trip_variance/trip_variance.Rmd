...
ggsave(f1, filename = "analyses/trip_variance/f1.png", width = 6, height = 5, units = "in")
ggsave(f2, filename = "analyses/trip_variance/f2.png", width = 6, height = 5, units = "in")
...
save_as_docx(t1, path = "analyses/trip_variance/t1.docx")
```
