...
I wrote a function that estimates the trip-level mean, variance, and standard error when given a data set of effort, the PSC and discards associated with that effort, and the trip column that those two data sets should be joined on:  
```{r function}
